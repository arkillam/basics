...
/**
 * The icon class displays an icon with a box with a grid of lines in it.
 * 
...
public class icon_grid extends icon_base
{
...
public void paintIcon (Component c, Graphics g, int x, int y)
{
	...
	for (int j = 4; j < (height - 4); j += 2)
	{
		g.drawLine (j, 2, j, height - 2);
	}
